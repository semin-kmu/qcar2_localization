...
-- Scenario 3: LiDAR + Odometry
-- Scan matching enhanced with wheel odometry
...
options = {
  ...
  published_frame = "base_link", -- cartographer provides map->odom->base_link TF
  odom_frame = "odom",
...
TRAJECTORY_BUILDER_2D.use_imu_data = false  -- NO IMU
...
-- option: optimize graph off
POSE_GRAPH.optimize_every_n_nodes = 0

POSE_GRAPH.constraint_builder.min_score = 0.65
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.7

-- Scan matching weight (default: 1.0)
